                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path d="M3 5a2 2 0 0 1 2-2h6l2 2h6a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5z" />
                              </svg>
                            <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Catalogos</span>
                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2" d="m1 1 4 4 4-4" />
